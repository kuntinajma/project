...
const AdminLayout: React.FC = () => {
		...
		switch (user?.role) {
			case 'superadmin':
				return [
					...
					{ name: 'Transportation', href: '/admin/transportation', icon: TruckIcon },
	...
	return (
		<div className="min-h-screen bg-gray-100 flex flex-row">
			...
			{/* Sidebar */}
			<div className={`fixed inset-y-0 left-0 z-50 w-64 lg:w-80 bg-white shadow-lg transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'
				}`}>
					...
					<div className="flex items-center justify-between h-16 px-4 sm:px-6 lg:px-8">
						...
						<div className="flex items-center space-x-4">
							...
							>
								...
								<h1 className="font-bold text-orange-600">Home</h1>
							</Link>
						</div>
					</div>
				</div>
