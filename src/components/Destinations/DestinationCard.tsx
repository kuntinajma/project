...
interface DestinationCardProps {
	...
	onViewDetailText: string;
}

const DestinationCard: React.FC<DestinationCardProps> = ({ destination, onViewDetails, onViewDetailText = "View Details" }) => {
